...
;; NOTE: Languages
;; TODO: Maybe automate this with a macro?
...
;; NOTE: Insert copyright header when creating a file
(add-hook 'find-file-hook (lambda()
                             (if (not (file-exists-p (buffer-file-name)))
                               (copyright "Marouene Boughoufa"))
                             (copyright-update)))

;; End Hooks

;; NOTE: Indent case labels in C-styled programs
